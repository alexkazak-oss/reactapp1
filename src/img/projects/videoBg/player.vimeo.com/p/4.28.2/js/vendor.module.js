...
;(Or['[object Arguments]'] =
	...
	Or['[object Uint32Array]'] =
		!0),
	(Or['[object Error]'] = Or['[object Function]'] = Or['[object WeakMap]'] = !1)
var xr = Math.max
function Ur(e, t, n) {
	return (
...
let qi = (function () {
	...
	return (
		...
		(t.removeCuePoint = function (e) {
			if (!e)
				throw new ki('InvalidCuePoint', 'The specified cue point is not valid.')
					...
					if ((this.reactivate(), this._telecineVideo !== e)) {
						if (
							...
							(this._files = e.files.filter(
								e => -1 !== this.constructor.supportedVideoTypes.indexOf(e.mime)
							)),
				...
				const t = this._queue.shift(),
					...
					a = {
						...
						data: {
							...
							isInitSegmentRequest: i,
							requestSendTime: Ki(),
							uuid: ([1e7] + -1e3 + -4e3 + -8e3 + -1e11).replace(/[018]/g, e =>
								(e ^ ((16 * Math.random()) >> (e / 4))).toString(16)
							),
						},
					}
							...
							: ae({ url: t, timeout: 1e4, type: e.MANIFEST })
									...
									.catch(e => {
										if (
											...
											return n.fire(ui.MEDIA_URL_EXPIRED), new Promise(() => {})
										throw (
...
let Ks = (function (e) {
		function t(t, n = {}) {
			var r, i
			return (
				((i = e.call(this, t, n) || this)._apiManifestUrl = null),
				(i._atLiveEdge = !0),
				(i._atLiveTail = !1),
				i.reset(),
			...
			r(t, [
				...
				},
				{
					...
					get: function () {
						...
						return e > 0 ? this._video.seekable.end(e - 1) : 0
					},
				},
				{
					key: 'atLiveEdge',
				...
				if (n === this._currentScanner) {
					switch (e) {
						...
						case ui.DRM_AUTH_FAILURE:
							this._fireVideoError('DRMFailure', { text: t.text, code: t.code })
							break
	...
	go = (function (e) {
		...
		a(t, e),
			...
			(t.frustumSurfaceArea = function (e, t, n) {
				const r = 2 * mo.SPHERE_RADIUS * 2 * Math.sin((Math.PI / 180) * (e / 2))
				return (
	...
	const c = {
		...
		get pictureInPictureEnabled() {
			const e = Le.spatialPlayback && a.video.spatial,
				t = Le.browser.safari && this.readyState < 1
			return (
				t && s.once(ii.LOADED_METADATA, () => r.fire(zo)),
...
var sl = (function (e) {
	...
	ol = rn(function (e, t) {
		Object.defineProperty(t, '__esModule', { value: !0 }), (t.Envelope = void 0)
		var n = (function () {
			function e(e, t) {
				;(this.event = e),
					(this.eid = (0, sl.v4)()),
								...
								e.isMasterPlaylist
									...
									: (function (e, t) {
											...
											t.partTargetDuration &&
												...
												t.skip > 0 &&
													e.push('#EXT-X-SKIP:SKIPPED-SEGMENTS='.concat(t.skip))
											var h,
												f = s(t.segments)
											try {
												for (f.s(); !(h = f.n()).done; ) {
